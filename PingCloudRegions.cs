...
public class PingCloudRegions : MonoBehaviour
{
	...
	private static CloudServerRegion closestRegion = CloudServerRegion.US;
	...
	private void Awake()
	{
		...
		if (PlayerPrefs.GetString("PUNCloudBestRegion", string.Empty) != string.Empty)
		{
			...
			closestRegion = (CloudServerRegion)(int)Enum.Parse(typeof(CloudServerRegion), @string, ignoreCase: true);
		}
		else
		{
