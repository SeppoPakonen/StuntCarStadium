...
public class CFX_SpawnSystem : MonoBehaviour
{
	...
	private void addObjectToPool(GameObject sourceObject, int number)
	{
		...
		{
			GameObject gameObject = (GameObject)Object.Instantiate((Object)sourceObject);
			gameObject.SetActive(value: false);
			WFX_AutoDestructShuriken[] componentsInChildren = gameObject.GetComponentsInChildren<WFX_AutoDestructShuriken>(includeInactive: true);
			WFX_AutoDestructShuriken[] array = componentsInChildren;
			foreach (WFX_AutoDestructShuriken wFX_AutoDestructShuriken in array)
			{
