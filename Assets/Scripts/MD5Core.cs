...
public sealed class MD5Core
{
	...
	{
		return b + LSR((uint)((int)a + ((int)(b & c) | (((int)b ^ -1) & (int)d)) + (int)x) + t, s);
	}

	private static uint r2(uint a, uint b, uint c, uint d, uint x, int s, uint t)
	{
		return b + LSR((uint)((int)a + ((int)(b & d) | ((int)c & ((int)d ^ -1))) + (int)x) + t, s);
	}
	...
	{
		return b + LSR((uint)((int)a + ((int)c ^ ((int)b | ((int)d ^ -1))) + (int)x) + t, s);
	}
