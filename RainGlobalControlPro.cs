...
public class RainGlobalControlPro : MonoBehaviour
{
	...
	public void Update()
	{
		...
		GameObject gameObject = GameObject.FindWithTag("FullscreenEffectPro");
		if (rainLevel == 0f && gameObject != null)
		{
			gameObject.get_renderer().enabled = false;
		}
		else
		{
			gameObject.get_renderer().enabled = true;
		}
